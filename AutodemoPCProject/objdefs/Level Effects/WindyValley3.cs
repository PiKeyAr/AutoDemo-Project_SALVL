...
namespace SADXObjectDefinitions.Level_Effects
{
	...
	{
		readonly NJS_OBJECT[] models = new NJS_OBJECT[4]; // The last model is custom made
		readonly Mesh[][] meshes = new Mesh[4][];
		Texture[] texs_sora62;
		Texture[] texs_sora96;
		Texture[] texs; // Whole PVM
		...
		public override void Render(Device dev, EditorCamera cam)
		{
			...
			result.AddRange(models[3].DrawModelTree(dev.GetRenderState<FillMode>(RenderState.FillMode), transform, texs, meshes[3], EditorOptions.IgnoreMaterialColors, EditorOptions.OverrideLighting));
